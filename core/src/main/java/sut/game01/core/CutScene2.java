...
public class CutScene2 extends Screen{
    ...
    public CutScene2(final ScreenStack ss){
        ...
        txt1 = assets().getImage("images/txt5.png");
        txt1Layer = graphics().createImageLayer(txt1);
        txt2 = assets().getImage("images/txt6.png");
        txt2Layer = graphics().createImageLayer(txt2);
        txt3 = assets().getImage("images/txt7.png");
        txt3Layer = graphics().createImageLayer(txt3);
        txt4 = assets().getImage("images/txt9.png");
        txt4Layer = graphics().createImageLayer(txt4);
        txt5 = assets().getImage("images/txt10.png");
        txt5Layer = graphics().createImageLayer(txt5);
        txt6 = assets().getImage("images/txt8.png");
    ...
    public void wasShown(){
        ...
        if(showDebugDraw){
            CanvasImage image = graphics().createImage(
                    (int) (width / CutScene2.M_PER_PIXEL),
                    (int) (height / CutScene2.M_PER_PIXEL));
            ...
            debugDraw.setFlags(DebugDraw.e_shapeBit |
                    ...
                    DebugDraw.e_aabbBit);
            debugDraw.setCamera(0,0,1f / CutScene2.M_PER_PIXEL);
