...
public class Stage extends UIScreen {
    ...
    public Stage(final ScreenStack ss){
        ...
        player = new Player(world,80f,330f);
        enemy  = new Enemy(world,700f,290f,0);
        ...
        loadingImage = assets().getImage("images/loading.gif");
        loadingLayer = graphics().createImageLayer(loadingImage);
    ...
    public void update(int delta) {
        ...
        if(stateKey == true) {
            player.layer().setTranslation(80f,280f);
            remaining--;
            updateBonus();
            ...
            if(enemy.layer().ty()+10 < 100) {
                bonus = level*1;
                track=1;
                ok.play();
            }else if(enemy.layer().ty()+10 < 190) {
                bonus = level*2;
                Score.x2++;
                ok.play();
                track=2;
            }else if(enemy.layer().ty()+10 < 230) {
                bonus = level*3;
                ok.play();
                Score.x3++;
                track=3;
            }else if(enemy.layer().ty()+10 < 280) {
                bonus = level*4;
                ok.play();
                Score.x4++;
                track=4;
